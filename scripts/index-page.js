...
function appendMessages(messagesArray){
    ...
    postedDate.innerText = new Date (messagesArray[i].timestamp).toLocaleString(Date.UTC).split(',')[0];
    ...
    function postNewComments(name, comment){
      ...
      function deleteComments(){
        axios.get(`https://project-1-api.herokuapp.com/comments:id?api_key=${key}`,{
